                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: const [
                          ...
                          SizedBox(height: 2),
                          Text('Junte-se ao ciclo têxtil e comece a doar ou coletar.',
                    ...
                    child: Column(
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: _dec('CPF', icon: Icons.credit_card_outlined),
                        ),
                        const SizedBox(height: 12),
                        TextFormField(
                        ...
                        TextFormField(
                          ...
                          decoration: _dec('Celular', icon: Icons.phone_outlined),
                        ),
                        const SizedBox(height: 12),
                        TextFormField(
                          controller: enderecoCtrl,
                          decoration: _dec('Endereço', icon: Icons.location_on_outlined),
                        ),
                        const SizedBox(height: 12),
                        TextFormField(
                          controller: senhaCtrl,
                          obscureText: obscure,
                          decoration: _dec('Senha', icon: Icons.lock_outline).copyWith(
                        ...
                        Row(
                          ...
                          children: [
                            Checkbox(
                              ...
                              onChanged: (v) => setState(() => termosAceitos = v ?? false),
                            ),
                            ...
                            Expanded(
                              child: Wrap(
                                children: const [
                                  ...
                                  Text('Termos de Uso', style: TextStyle(fontWeight: FontWeight.w600)),
                                  Text(' e '),
                                  Text('Política de Privacidade', style: TextStyle(fontWeight: FontWeight.w600)),
                                  Text('.'),
                                ],
                              ),
                            ),
